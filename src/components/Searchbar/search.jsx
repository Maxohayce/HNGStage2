...
const SearchBar = ({ search, query, change }) => {
    ...
    return (
        <form className="searchBar" onSubmit={search}>
            ...
            <input onChange={change} className="searchBox" type="search" value={query} placeholder="What do you want to watch ?" name="query" />
            <button className="searchButton" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
